...
public class RTDiagnoseZhenTiActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diagnose_zhenti);
        httpConfig = new HttpConfig();
        dialogView = new DialogView(RTDiagnoseZhenTiActivity.this);
        initView();
        initData();
    }
    ...
    protected void initView() {
        ...
        titleCenter.setText("真题诊断报告");
    }

    @Override
    protected void initData() {
        getRecord(AddressConfig.GET_ZHENTI_RECORD);
    }
            ...
            public void onResponse(ReportListPro response, int id) {
                ...
                if (response.errorCode == 0) {
                    if (response.getContent() != null) {
                        DiagnoseQuanKeAdapter reportListAdapter = new DiagnoseQuanKeAdapter(RTDiagnoseZhenTiActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.common_head_left:
                IntentUtil.finish(RTDiagnoseZhenTiActivity.this);
                break;
        }
    }
}
