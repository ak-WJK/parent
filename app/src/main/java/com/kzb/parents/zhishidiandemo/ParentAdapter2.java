...
*一级级菜单适配器
* */
public class ParentAdapter2 extends BaseExpandableListAdapter {
    ...
    public ParentAdapter2(Context context, List<ZhangModel> parents, String type) {
    ...
    public int getChildrenCount(int groupPosition) {
        int size = mParents.get(groupPosition).getJie().size();
        LogUtils.e("TAG", "节的条目数  " + size);
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        final ChildAdapter2 childAdapter = new ChildAdapter2(mContext,
                childs, type);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.parent_group_item2, parent, false);
