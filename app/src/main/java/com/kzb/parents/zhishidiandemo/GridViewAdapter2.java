...
public class GridViewAdapter2 extends CommonAdapter<KnowledgeModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder viewHolder = ViewHolder.get(mContext, convertView, parent, R.layout.grid_item2, position);

        TextView textView = viewHolder.getView(R.id.child_view);
