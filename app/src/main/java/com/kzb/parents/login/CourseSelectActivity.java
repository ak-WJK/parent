...
public class CourseSelectActivity extends BaseActivity implements View.OnClickListener {
...
//        dialogView.handleDialog(true);
        ...
        if (null == SpSetting.loadLoginInfo() || null == SpSetting.loadLoginInfo().getUid()) {
            IntentUtil.startActivity(CourseSelectActivity.this, LoginTypeActivity.class);
            return;
        }
...
//                dialogView.handleDialog(false);
                ...
                if (response != null && response.errorCode == 0 && response.getContent() != null) {
                    ...
                    MineToast.show(CourseSelectActivity.this, response.msg);
                }
    ...
    private void setVal(List<CourseResponse.CourseModel> listVals) {
        ...
        final CourseAdapter courseAdapter = new CourseAdapter(CourseSelectActivity.this);
...
//                    saveCourse(courseModel);
    ...
    private void saveCourse() {
        ...
        if (tempModel == null) {
            MineToast.show(CourseSelectActivity.this, "请选择课程！");
            return;
        }
