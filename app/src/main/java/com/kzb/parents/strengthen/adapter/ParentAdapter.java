...
import com.kzb.parents.course.adapter.*;
...
public class ParentAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		final com.kzb.parents.course.adapter.ChildAdapter childAdapter = new com.kzb.parents.course.adapter.ChildAdapter(this.mContext,
				childs,type);
