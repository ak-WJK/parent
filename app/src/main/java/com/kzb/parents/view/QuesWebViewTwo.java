...
public class QuesWebViewTwo extends WebView {
    double mHeight;
    private float mRate = 0.4f;
    public QuesWebViewTwo(Context context) {
        super(context);
        setCommonWebView(this);
    }

    public QuesWebViewTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCommonWebView(this);
//        setBackgroundColor(Color.parseColor("#0000ff"));
    }

    public QuesWebViewTwo(Context context, AttributeSet attrs, int defStyleAttr) {
