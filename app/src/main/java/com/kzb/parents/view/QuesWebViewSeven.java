...
public class QuesWebViewSeven extends WebView {
    ...
    public QuesWebViewSeven(Context context, AttributeSet attrs) {
        super(context, attrs);
//        setBackgroundColor(Color.parseColor("#0000ff"));
    }

    public QuesWebViewSeven(Context context, AttributeSet attrs, int defStyleAttr) {
