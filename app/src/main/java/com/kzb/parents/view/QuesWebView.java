...
public class QuesWebView extends WebView {
    double mHeight;
    private float mRate = 0.65f;
    public QuesWebView(Context context) {
        super(context);
        setCommonWebView(this);
    }

    public QuesWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCommonWebView(this);
//        setBackgroundColor(Color.parseColor("#0000ff"));
    }

    public QuesWebView(Context context, AttributeSet attrs, int defStyleAttr) {
