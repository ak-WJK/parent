...
import com.kzb.parents.view.exam.ZTJXQuestionView;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case HANDLER_TIME_OVER:
                    Toast.makeText(ZTJXActivity.this, "时间到，正在提交试卷", Toast.LENGTH_SHORT).show();
//                    submit();
                    break;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTwoBtnDialog = new CommonTwoBtnDialog(ZTJXActivity.this);
        progressBar = new ProgressDialogView(ZTJXActivity.this);
        mExamDialog = new ExamDialog(ZTJXActivity.this);
        mAtackDialog = new AtackDialog(ZTJXActivity.this);
        ...
        backDialog.setOnDialogClickListener(new CommonTwoBtnDialog.OnDialogClickListener() {
            ...
            public void onPositiveClick() {
                IntentUtil.finish(ZTJXActivity.this);
            }
        });
...
//                getQuestion(AddressConfig.CHAPTER_QUESTION_LIST);
    ...
    protected void initView() {
        ...
        questionView.setActivityV(ZTJXActivity.this);
...
////            Intent intent = new Intent(ZTJXActivity.this, StrongReportActivity.class);
////            intent.putExtra("question",new Gson().toJson(question));
////            intent.putExtra("point",mPoint);
////            intent.putExtra("kid",mKid);
////            IntentUtil.startActivityWithFinish(ZTJXActivity.this, intent);
////            return;
//        }
//
...
//                dialogView.handleDialog(false);
//                Toast.makeText(ZTJXActivity.this, "提交失败", Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
...
//
//                            dialogView.handleDialog(false);
////                            Intent intent = new Intent(ZTJXActivity.this, WrongStrongActivity.class);
//                            Intent intent = new Intent(ZTJXActivity.this, WrongStrongTwoActivity.class);
////                            Intent intent = new Intent(ZTJXActivity.this, StrongReportTwoActivity.class);
//                            intent.putExtra("question", new Gson().toJson(question));
//                            intent.putExtra("point", mPoint);
//                            intent.putExtra("kid", mKid);
...
//                            return;
//                        }
////                        final Intent intent = new Intent(ZTJXActivity.this, ReportTwoActivity.class);
//                        final Intent intent = new Intent(ZTJXActivity.this, DiagNoseDetailActivity.class);
//                        if (TextUtils.isEmpty(mTestId)) {
...
//                                    ZTJXActivity.this.finish();
//                                }
//
//                                @Override
//                                public void onReplay() {
//                                    Intent intent = new Intent(ZTJXActivity.this, ZTJXActivity.class);
    ...
    public void getQuestion(String url) {
        ...
        httpConfig.doPostRequest(HttpConfig.getBaseRequest(url, json), new GenericsCallback<ExamQuestion>(new JsonGenericsSerializator()) {
            ...
            public void onError(Call call, Exception e, int id) {
                ...
                Toast.makeText(ZTJXActivity.this, "获取题目失败", Toast.LENGTH_SHORT).show();
            }
...
//                            });
                    ...
                    Toast.makeText(ZTJXActivity.this, "暂时没有对应试题...", Toast.LENGTH_SHORT).show();
                }
    ...
    public void getNeedknow() {
        ...
        httpConfig.doPostRequest(HttpConfig.getBaseRequest(url, json), new GenericsCallback<NeedKnowPro>(new JsonGenericsSerializator()) {
            ...
            public void onError(Call call, Exception e, int id) {
                dialogView.handleDialog(false);
                Toast.makeText(ZTJXActivity.this, "获取须知失败", Toast.LENGTH_SHORT).show();
            }
