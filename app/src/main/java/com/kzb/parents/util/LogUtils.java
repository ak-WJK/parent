    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && com.kzb.parents.application.Application.mContext.getExternalCacheDir() != null)
                dir = com.kzb.parents.application.Application.mContext.getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = com.kzb.parents.application.Application.mContext.getCacheDir() + File.separator + "log" + File.separator;
            }
        }
